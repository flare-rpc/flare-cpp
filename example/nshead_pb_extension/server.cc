...
class MyNsheadProtocol : public flare::rpc::NsheadPbServiceAdaptor {
public:
    void ParseNsheadMeta(
        const flare::rpc::Server&, const flare::rpc::NsheadMessage&,
        flare::rpc::Controller*,
        flare::rpc::NsheadMeta* out_meta) const {
    ...
    void ParseRequestFromCordBuf(const flare::rpc::NsheadMeta&,
        ...
        if (!echo_req) {
            cntl->SetFailed(flare::rpc::EREQUEST, "Fail to parse request");
            return;
        }
