...
public:
    explicit CancelRPC(flare::rpc::CallId rpc_id) : _rpc_id(rpc_id) {}
    
    void Run() {
        flare::rpc::StartCancel(_rpc_id);
    }
    
private:
    flare::rpc::CallId _rpc_id;
};
...
int main(int argc, char* argv[]) {
    ...
    while (!flare::rpc::IsAskedToQuit()) {
        ...
        const flare::rpc::CallId id1 = cntl1.call_id();
        const flare::rpc::CallId id2 = cntl2.call_id();
        CancelRPC done1(id2);
        CancelRPC done2(id1);
