...
int main() {
    ...
    flare::dynamic_bitset <uint32_t> a(12, 0b0100010110111);
    ...
    // get allocator
    const flare::dynamic_bitset<uint32_t>::allocator_type allocator = a.get_allocator();
    ...
    flare::dynamic_bitset <uint32_t> b("011001010101");
