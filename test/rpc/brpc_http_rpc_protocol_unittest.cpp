...
protected:
    ...
    void MakeH2EchoRequestBuf(flare::io::IOBuf* out, flare::rpc::Controller* cntl, int* h2_stream_id) {
...
TEST_F(HttpTest, http2_header_after_data) {
    ...
    flare::io::IOBuf res_out;
    {
        ...
        flare::rpc::policy::SerializeFrameHead(headbuf, header2.size(),
                flare::rpc::policy::H2_FRAME_HEADERS, 0x05/* end header and stream */,
                h2_stream_id);
        // append header2
        res_out.append(headbuf, sizeof(headbuf));
...
TEST_F(HttpTest, http2_handle_goaway_streams) {
    ...
    ASSERT_EQ((ssize_t)flare::rpc::policy::FRAME_HEAD_SIZE + 8, ::write(servfd, goawaybuf, flare::rpc::policy::FRAME_HEAD_SIZE + 8));
