...
namespace {
    ...
    using future_type = flare::basic_future<test_alloc<void>, int>;
    using promise_type = flare::basic_promise<test_alloc<void>, int>;
    ...
    struct pf_set {
        ...
        void complete() {
            ...
            pf[2].p.finish(flare::expected<int, std::exception_ptr>(1));
            pf[3].p.finish(
