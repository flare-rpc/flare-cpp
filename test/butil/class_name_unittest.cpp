...
TEST_F(ClassNameTest, demangle) {
    ...
    ASSERT_EQ("dp::FiberPBCommand<proto::PbRouteTable, proto::PbRouteAck>::marshal(dp::ParamWriter*)::__FUNCTION__",
              flare::base::demangle("_ZZN2dp14FiberPBCommandIN5proto12PbRouteTableENS1_10PbRouteAckEE7marshalEPNS_11ParamWriterEE12__FUNCTION__"));
...
TEST_F(ClassNameTest, class_name_sanity) {
    ...
    ASSERT_STREQ("butil::foobar::MyClass", flare::base::class_name<butil::foobar::MyClass>());
