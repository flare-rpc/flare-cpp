...
void ReducerTest_window() {
    ...
    flare::Window<flare::Maxer<int> > w4(&c2, 1);
    flare::Window<flare::Maxer<int> > w5(&c2, 2);
    flare::Window<flare::Maxer<int> > w6(&c2, 3);
    flare::Window<flare::Miner<int> > w7(&c3, 1);
    flare::Window<flare::Miner<int> > w8(&c3, 2);
    flare::Window<flare::Miner<int> > w9(&c3, 3);
