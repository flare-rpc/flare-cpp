...
// BasicStringPiece<std::string> or BasicStringPiece<butil::string16>.
    ...
    public:
        ...
        BasicStringPiece(const std::basic_string_view<typename STRING_TYPE::value_type> &str)
                : ptr_(str.data()), length_(str.size()) {}
...
// MSVC doesn't like complex extern templates and DLLs.
    ...
    extern template
    class BUTIL_EXPORT BasicStringPiece<std::string>;

    extern template
    class BUTIL_EXPORT BasicStringPiece<string16>;
