...
// is the last one on the right, the right is deallocated.
        ...
        flare::base::scoped_generic<mach_port_t, internal::SendRightTraits>;
...
// outstanding send rights into dead names.
        ...
        flare::base::scoped_generic<mach_port_t, internal::ReceiveRightTraits>;
...
// the receive rights that are members of the port set.
        using ScopedMachPortSet = flare::base::scoped_generic<mach_port_t, internal::PortSetTraits>;
