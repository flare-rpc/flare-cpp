...
//
// flare::variable::LatencyRecorder
...
// To be compatible with the old version
        using namespace ::flare::variable;
    }  // namespace utils
}  // namespace flare::variable
...
// Specialize lock_guard and unique_lock
    template<typename Mutex>
    class lock_guard<flare::variable::MutexWithRecorder<Mutex> >
            : public ::flare::variable::detail::
            LockGuardBase<::flare::variable::MutexWithRecorder<Mutex> > {
    public:
        typedef ::flare::variable::detail::
        LockGuardBase<flare::variable::MutexWithRecorder<Mutex> > Base;

        explicit lock_guard(::flare::variable::MutexWithRecorder<Mutex> &mutex)
                : Base(mutex) {}
    };

    template<typename Mutex>
    class lock_guard<flare::variable::MutexWithLatencyRecorder<Mutex> >
            : public ::flare::variable::detail::
            LockGuardBase<::flare::variable::MutexWithLatencyRecorder<Mutex> > {
    public:
        typedef ::flare::variable::detail::
        LockGuardBase<flare::variable::MutexWithLatencyRecorder<Mutex> > Base;

        explicit lock_guard(::flare::variable::MutexWithLatencyRecorder<Mutex> &mutex)
                : Base(mutex) {}
    };

    template<typename Mutex>
    class unique_lock<flare::variable::MutexWithRecorder<Mutex> >
            : public ::flare::variable::detail::
            UniqueLockBase<::flare::variable::MutexWithRecorder<Mutex> > {
    public:
        typedef ::flare::variable::detail::
        UniqueLockBase<::flare::variable::MutexWithRecorder<Mutex> > Base;
    ...
    template<typename Mutex>
    class unique_lock<flare::variable::MutexWithLatencyRecorder<Mutex> >
            : public ::flare::variable::detail::
            UniqueLockBase<::flare::variable::MutexWithLatencyRecorder<Mutex> > {
    public:
        typedef ::flare::variable::detail::
        UniqueLockBase<::flare::variable::MutexWithLatencyRecorder<Mutex> > Base;
        typedef typename Base::mutex_type mutex_type;
