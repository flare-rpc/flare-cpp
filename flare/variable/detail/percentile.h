...
#include <math.h>                       // ceil
#include "flare/variable/reducer.h"               // Reducer
#include "flare/variable/window.h"                // Window
#include "flare/variable/detail/combiner.h"       // AgentCombiner
#include "flare/variable/detail/sampler.h"        // ReducerSampler
