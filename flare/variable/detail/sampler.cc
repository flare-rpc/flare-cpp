...
// Combine two circular linked list into one.
        ...
        private:
            ...
            static void child_callback_atfork() {
                flare::get_leaky_singleton<SamplerCollector>()->after_forked_as_child();
            }
        ...
        static flare::variable::PerSecond<flare::variable::PassiveStatus<double> > *s_sampling_thread_usage_variable = nullptr;
#endif
        ...
        void Sampler::schedule() {
            *flare::get_leaky_singleton<SamplerCollector>() << this;
        }
