...
// A thread and a special variable to collect samples submitted.
    class Collector : public flare::variable::Reducer<Collected *, CombineCollected> {
    public:
        Collector();
...
// for limiting samples returning NULL in speed_limit()
    ...
    void Collector::grab_thread() {
        ...
        flare::variable::PerSecond<flare::variable::PassiveStatus<double> > busy_seconds_second(
                "variable_collector_grab_thread_usage", &busy_seconds_var);

        flare::variable::PassiveStatus<int64_t> ngrab_var(deref_value<int64_t>, &_ngrab);
        flare::variable::PerSecond<flare::variable::PassiveStatus<int64_t> > ngrab_second(
...
// Call user's callbacks in this thread.
    void Collector::dump_thread() {
        ...
        flare::variable::PassiveStatus<int64_t> ndumped_var(deref_value<int64_t>, &_ndump);
        flare::variable::PerSecond<flare::variable::PassiveStatus<int64_t> > ndumped_second(
                "flare::variable::collector_dump_second", &ndumped_var);
