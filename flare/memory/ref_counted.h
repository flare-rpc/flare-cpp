...
#ifndef FLARE_MEMORY_REF_COUNTED_H_
#define FLARE_MEMORY_REF_COUNTED_H_
...
// the object accidently while there are references to it.
    ...
    private:
        FLARE_DISALLOW_COPY_AND_ASSIGN(RefCounted<T>);
    };
...
//     ~MyFoo();
    ...
    private:
        ...
        FLARE_DISALLOW_COPY_AND_ASSIGN(RefCountedThreadSafe);
    };
...
#endif  // FLARE_MEMORY_REF_COUNTED_H_
