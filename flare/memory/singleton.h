...
#ifndef FLARE_MEMORY_SINGLETON_H_
#define FLARE_MEMORY_SINGLETON_H_
...
namespace flare::memory {
    namespace internal {
        ...
        FLARE_EXPORT intptr_t WaitForInstance(std::atomic<intptr_t> *instance);
    ...
    struct StaticMemorySingletonTraits {
        ...
        static Type *New() {
            ...
            int32_t old = 0;
            if (dead_.compare_exchange_weak(old, 1, std::memory_order_acquire))
                return nullptr;
