        ...
        private:
            ...
            bool has_element(const value_type &elem, size_t hashval) const {
                ...
                while (true) {
                    ...
                    if (FLARE_LIKELY(g.MatchEmpty())) return false;
                    seq.next();
        ...
        protected:
            ...
            std::pair<size_t, bool> find_or_prepare_insert(const K &key, size_t hashval) {
                ...
                while (true) {
                    ...
                    if (FLARE_LIKELY(g.MatchEmpty())) break;
                    seq.next();
                }
...
// ----------------------------------------------------------------------------
        ...
        for (auto& inner : sets_)
            ...
            bool if_contains_unsafe(const key_arg<K> &key, F &&f) const {
                return const_cast<parallel_hash_set *>(this)->template
                        modify_if_impl<K, F, LockableBaseImpl<flare::NullMutex>::DoNothing>(key, std::forward<F>(f));
            }
...
// --------------------------------------------------------------------------
        ...
        struct NodeHashSetPolicy
                : flare::priv::node_hash_policy<T &, NodeHashSetPolicy<T>> {
            using key_type = T;
            using init_type = T;
            using constant_iterators = std::true_type;
...
// --------------------------------------------------------------------------
    ...
    class flat_hash_set
            : public flare::priv::raw_hash_set<
                    flare::priv::FlatHashSetPolicy<T>, Hash, Eq, Alloc> {
...
// -----------------------------------------------------------------------------
    ...
    class flat_hash_map : public flare::priv::raw_hash_map<
            flare::priv::FlatHashMapPolicy<K, V>,
            Hash, Eq, Alloc> {
...
// -----------------------------------------------------------------------------
    ...
    class node_hash_set
            : public flare::priv::raw_hash_set<
                    flare::priv::NodeHashSetPolicy<T>, Hash, Eq, Alloc> {
...
// -----------------------------------------------------------------------------
    ...
    class node_hash_map
            : public flare::priv::raw_hash_map<
                    flare::priv::NodeHashMapPolicy<Key, Value>, Hash, Eq,
                    Alloc> {
...
// -----------------------------------------------------------------------------
    ...
    class parallel_flat_hash_set
            : public flare::priv::parallel_hash_set<
                    ...
                    flare::priv::FlatHashSetPolicy<T>,
                    Hash, Eq, Alloc> {
