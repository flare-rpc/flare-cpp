...
#ifndef FLARE_FUTURE_INTERNAL_FUTURE_UTILS_H_
#define FLARE_FUTURE_INTERNAL_FUTURE_UTILS_H_
...
#include "flare/future/internal/basics.h"
#include "flare/future/internal/impls.h"
...
namespace flare {
    namespace future_internal {
        ...
        -> flare::future_internal::detail::optional_or_bool_t<unboxed_type_t<Ts...>>;
        ...
        auto blocking_try_get_preserving_errors(future<Ts...> &&future,
            ...
            if constexpr (flare::future_internal::detail::is_duration_v<DurationOrTimePoint>) {
...
#endif  // FLARE_FUTURE_INTERNAL_FUTURE_UTILS_H_
