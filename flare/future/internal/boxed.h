...
#ifndef FLARE_FUTURE_INTERNAL_BOXED_H_
#define FLARE_FUTURE_INTERNAL_BOXED_H_
...
#include "flare/future/internal/types.h"
...
namespace flare {
    ...
    namespace future_internal {
        ...
        template<class... Ts>
        std::add_rvalue_reference_t<unboxed_type_t < Ts...>>
...
#endif  // FLARE_FUTURE_INTERNAL_BOXED_H_
