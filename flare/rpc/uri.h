...
namespace flare::rpc {
    ...
    public:
        ...
        typedef flare::container::FlatMap<std::string, std::string> QueryMap;
        ...
        FLARE_DEPRECATED const std::string &schema() const { return scheme(); }
        ...
        FLARE_DEPRECATED void set_schema(const std::string &s) { set_scheme(s); }
...
namespace std {
    template<>
    inline void swap(flare::rpc::URI &lhs, flare::rpc::URI &rhs) {
        lhs.Swap(rhs);
    }
}  // namespace std
