...
#include "flare/rpc/channel_base.h"              // ChannelBase
#include "flare/rpc/adaptive_protocol_type.h"    // AdaptiveProtocolType
#include "flare/rpc/adaptive_connection_type.h"  // AdaptiveConnectionType
...
#include "flare/rpc/naming_service_filter.h"
...
struct ChannelOptions {
    ...
    // Serialization protocol, defined in flare/rpc/options.proto
    ...
    // defined in flare/rpc/retry_policy.h
    ...
    // in flare/rpc/naming_service_filter.h
    // This object is NOT owned by channel and should remain valid when
    // channel is used.
    // Default: NULL
