...
ParseResult ParseThriftMessage(flare::io::cord_buf* source, Socket* socket, bool read_eof, const void *arg);
...
void SerializeThriftRequest(flare::io::cord_buf* request_buf, Controller* controller,
