...
#include "flare/rpc/policy/sofa_pbrpc_meta.pb.h" // SofaRpcMeta
...
namespace flare::rpc {
    namespace policy {
        ...
        static void SerializeSofaHeaderAndMeta(
                flare::cord_buf *out, const SofaRpcMeta &meta, int payload_size) {
        ...
        ParseResult ParseSofaMessage(flare::cord_buf *source, Socket *socket,
...
// Defined in baidu_rpc_protocol.cpp
        ...
        void ProcessSofaRequest(InputMessageBase *msg_base) {
            ...
            if (!ParsePbFromCordBuf(&meta, msg->meta)) {
                ...
                socket->SetFailed(EREQUEST, "Fail to parse SofaRpcMeta from {}",
        ...
        void PackSofaRequest(flare::cord_buf *req_buf,
                             SocketMessage **,
