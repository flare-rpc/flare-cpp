...
ParseResult ParseNsheadMessage(flare::io::IOBuf* source, Socket* socket, bool read_eof, const void *arg);
...
void SerializeNsheadRequest(flare::io::IOBuf* request_buf, Controller* controller,
