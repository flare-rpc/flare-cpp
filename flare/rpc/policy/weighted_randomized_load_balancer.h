...
#ifndef FLARE_RPC_POLICY_WEIGHTED_RANDOMIZED_LOAD_BALANCER_H_
#define FLARE_RPC_POLICY_WEIGHTED_RANDOMIZED_LOAD_BALANCER_H_
...
#endif  // FLARE_RPC_POLICY_WEIGHTED_RANDOMIZED_LOAD_BALANCER_H_
