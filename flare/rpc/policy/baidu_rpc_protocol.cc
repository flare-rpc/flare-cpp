...
#include "flare/rpc/rpc_dump.h"                      // SampledRequest
#include "flare/rpc/policy/baidu_rpc_meta.pb.h"      // RpcRequestMeta
...
ParseResult ParseRpcMessage(flare::cord_buf* source, Socket* socket,
...
void PackRpcRequest(flare::cord_buf* req_buf,
                    SocketMessage**,
                    uint64_t correlation_id,
                    const google::protobuf::MethodDescriptor* method,
                    Controller* cntl,
                    const flare::cord_buf& request_body,
