...
void ReadThriftException(const flare::cord_buf& body,
...
ParseResult ParseThriftMessage(flare::cord_buf* source,
...
void SerializeThriftRequest(flare::cord_buf* request_buf, Controller* cntl,
