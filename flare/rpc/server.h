...
#include "flare/rpc/ssl_options.h"                  // ServerSSLOptions
#include "flare/rpc/describable.h"                  // User often needs this
#include "flare/rpc/data_factory.h"                 // DataFactory
#include "flare/rpc/builtin/tabbed.h"
#include "flare/rpc/details/profiler_linker.h"
#include "flare/rpc/health_reporter.h"
...
namespace flare::rpc {
    ...
    struct ServerOptions {
        ...
        // Adaptor for Mongo protocol, check flare/rpc/mongo_service_adaptor.h for details
        ...
        // flare automatically schedules "io" and "worker" code for better
        ...
        // in server.
        // If this option is NULL, flare::rpc::thread_local_data() is always NULL.
        // NOT owned by Server and must be valid when Server is running.
        // Default: NULL
        const DataFactory *thread_local_data_factory;

        // Prepare so many thread-local data before server starts, so that calls
        // to flare::rpc::thread_local_data() get data directly rather than calling
        ...
        // For processing RTMP connections. Read flare/rpc/rtmp.h for details.
        ...
        // For processing Redis connections. Read flare/rpc/redis.h for details.
        // Owned by Server and deleted in server's destructor.
    ...
    struct ServiceOptions {
        ...
        // Services that use older versions of flare may need to turn this
