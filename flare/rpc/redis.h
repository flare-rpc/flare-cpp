...
// Assign an instance to ServerOption.redis_service to enable redis support. 
    ...
    public:
        ...
        // This function should not be touched by user and used by flare deverloper only.
...
// The Command handler for a redis request. User should impletement Run().
    ...
    public:
        ...
        // an start marker and flare will call MultiTransactionHandler() to new a transaction
        ...
        // The Run() returns CONTINUE for "multi", which makes flare call this method to
        ...
        // then flare calls NewTransactionHandler() to new a transaction_handler.
        // 2) flare calls transaction_handler.Run() with command "set k1 v1",
        // which should return CONTINUE.
        // 3) flare calls transaction_handler.Run() with command "set k2 v2",
        // which should return CONTINUE.
        // 4) flare calls transaction_handler.Run() with command "set k3 v3",
        // which should return CONTINUE.
