...
// <A href="mailto:jakkhandy@hotmail.com">jakkhandy@hotmail.com</A>
    ...
    int FileChecksum(const char *file_path, unsigned char *checksum) {
        ...
        flare::hash::MurmurHash3_x64_128_Init(&mm_ctx, 0);
        while ((size = read(fd, block, sizeof(block))) > 0) {
            flare::hash::MurmurHash3_x64_128_Update(&mm_ctx, block, size);
        }
        flare::hash::MurmurHash3_x64_128_Final(checksum, &mm_ctx);
        return 0;
    }
