...
#ifndef FLARE_RPC_BUILTIN_FLOT_MIN_JS_H_
#define FLARE_RPC_BUILTIN_FLOT_MIN_JS_H_
...
const flare::cord_buf& flot_min_js_iobuf_gzip();

} // namespace flare::rpc


#endif // FLARE_RPC_BUILTIN_FLOT_MIN_JS_H_
