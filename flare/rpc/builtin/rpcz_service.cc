...
#include "flare/rpc/builtin/rpcz_service.h"
...
// Defined in span.cpp
    ...
    FLARE_RPC_VALIDATE_GFLAG(enable_rpcz, PassValidate);

    DEFINE_bool(rpcz_hex_log_id, false, "Show log_id in hexadecimal");
    FLARE_RPC_VALIDATE_GFLAG(rpcz_hex_log_id, PassValidate);
    ...
    void RpczService::enable(::google::protobuf::RpcController *cntl_base,
                             const ::flare::rpc::RpczRequest *,
                             ::flare::rpc::RpczResponse *,
