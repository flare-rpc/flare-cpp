...
#ifndef FLARE_RPC_PARTITION_CHANNEL_H_
#define FLARE_RPC_PARTITION_CHANNEL_H_

// To flare developers: This is a header included by user, don't depend
// on internal structures, use opaque pointers instead.

#include "flare/rpc/parallel_channel.h"
#include "flare/rpc/selective_channel.h" // For DynamicPartitionChannel
...
namespace flare::rpc {
    ...
    struct PartitionChannelOptions : public ChannelOptions {
        ...
        flare::container::intrusive_ptr<ResponseMerger> response_merger;
    };
...
#endif  // FLARE_RPC_PARTITION_CHANNEL_H_
