...
static flare::variable::PassiveStatus<int> s_bthread_key_count(
    "bthread_key_count", get_key_count, NULL);
static flare::variable::PassiveStatus<size_t> s_bthread_keytable_count(
    "bthread_keytable_count", get_keytable_count, NULL);
static flare::variable::PassiveStatus<size_t> s_bthread_keytable_memory(
...
int fiber_key_create(fiber_local_key* key, void (*dtor)(void*)) {
    if (dtor == NULL) {
        ...
        return bthread_key_create2(key, flare::fiber_internal::arg_as_dtor, (const void*)dtor);
    }
}
